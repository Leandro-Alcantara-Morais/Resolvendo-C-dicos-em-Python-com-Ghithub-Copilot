# Resolvendo-Códicos-em-python-com-o-Ghithub-Copilot
##Veremos resoluções de códicos em python utilizando o Ghithub Copilot ou ChatGPT
---------
...
###  Descrição: Vamos receber dois dados diferentes do usuário e concatena-los em uma única string?!  
    ...
    Concatenação
    Entrada de dados
    Utilização eficiente doGhithb Copilot ou ChatGpt

## 2- Repetindo textos
### Descrição: Agora vamos solicitarr u,a string e um número inteiro como entrada. Depois teremos que retrnar a string repetida o número de vezes informado.

    O que aprederemos?
    Manipulaçãode Strings (string)
    Números Inteiros (int)
    Múltiplas repetições
    Entrada de dados
    Aproveitar as sugestoõesd do Ghithub Copilot]

## 3- Operação Matematica Simples   
### Descrição: Vamos solicitar como entrada dois números e depois vamos realizar uma operação simples entre eles.

    Operação de matemáticas Básicas
    Entrada de dados
